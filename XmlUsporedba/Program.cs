...
namespace XmlUsporedba
{
    internal class Program
    {
        static void Main(string[] args)
        {
            XElement PrviXML = XElement.Load(@"C:\Users\ucenik\Desktop\NE TICI\prvi.xml");
            XElement DrugiXML = XElement.Load(@"C:\Users\ucenik\Desktop\NE TICI\drugi.xml");
            int brojpomagalo = 0;
